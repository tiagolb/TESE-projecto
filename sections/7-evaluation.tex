...
% FALTA FALAR DA DRIVER DE DISPLAY
...
%Seria possível tentar comparar o desempenho do sistema com o desempenho de um sistema parecido? Outra coisa que podes avaliar é a complexidade da TCB e a superficie final de ataque.
