...
%problemas DONE
%permission refinement é isto e seria fixe porque isto
%apresentar os mesmos sistemas que o Nuno e Miguel e dizer que nao servem pelas mesmas razoes que eles dizem
%dizer que o sistema do nuno e miguel é melhor porque faz isto e aquilo mas mesmo assim nao serve porque tem o problema do malware
...
\begin{table}[htbp!]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l||l|l|l|l|}
			\hline
			Security Mechanism          & Confidentiality & Data Integrity & Malware \\ \hline \hline
			Digital Rights Management   & \cmark          & \cmark         & \xmark  \\ \hline
			Access Control Mechanisms   & \cmark          & \cmark         & \xmark  \\ \hline
			...
			TrustZone Technology        & \cmark          & \cmark         & \cmark  \\ \hline
		\end{tabular}
	}
\end{table}
