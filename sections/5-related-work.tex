...
This subsection describes mechanisms and implementations of systems responsible for limiting applications' access to system resources, hence access control mechanisms. % DIZER QUAIS SÂO?
...
\subsubsection{Trusted Execution Environments} %ISTO NAO SE PODE CHAMAR TEE

% INTRO QUALQUER A DIZER O QUE CONSIDERAMOS SER TEE


%CONTINUO A ACHAR QUE ISTO DEVE SAIR DAQUI
...
%A whitepaper \cite{trustzone_whitepaper} by ARM describes the architecture
