...
% NUNO - Podes relacionar isto de alguma maneira com ataques ao output, relacionando assim estes sistemas com o teu objectivo? Basta acrescentar uma ou duas linhas no último parágrafo.
...
% NUNO - Não se percebe muito bem como é que isto finciona. O MockDroid não faz uma especie de sanitização dos dados enviados substituindo informação autentica mas privacy-sensitive por informação inócua?
...
% Nunca referencias a Figura 3 em lado nenhum na secção da página 14. Pf, explica brevemente o que é e que o OS está no normal e o trusted code está no secure world.
...
% For this reason, there is a need to create a trusted service for secure content display.
...
% Uma frase a dizer que normalmente o grande desafio técnico é que os drivers tendem a inflacionar muito a TCB e que estes sistemas conseguem precisamente implementar drivers muito pequenos pois são vocacionados para uma tarefa muito específica.
