...
To reduce the \ac{TCB} and offer an isolated environment for security critical applications, the research community has developed execution environments~\cite{li2014droidvault,genode,t6_tee,knox_whitepaper,brasserregulating,fitzekandix,kostiainen2012board,li2014building,li2015adattester,mcgillion2015open,sun2015trustotp,sun2015trustice,sun2015reliable,santos2011trusted,sierra_tee,tlk,aks,op_tee}, based on microkernels, and trusted hardware technologies~\cite{trustzone_whitepaper}. But these systems generally do not support, or make it very hard for application developers to offer secure display seamlessly integrated into the application's user interface.
...
% Clarifica melhor isto dizendo por exemplo que se pretende oferecer aos programadores de aplicações abstracções de programação simples e familiares para fazer rendering the conteúdos protegidos nas suas aplicações.
